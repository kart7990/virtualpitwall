...
namespace iRacingSdkWrapper
{
    ...
    public sealed class TelemetryInfo
    {
        ...
        public TelemetryValue<float> LapDeltaToSessionLastLap { get { return new TelemetryValue<float>(sdk, "LapDeltaToSessionLastLap"); } }
        ...
        public TelemetryValue<int> SessionLapsRemain { get { return new TelemetryValue<int>(sdk, "SessionLapsRemain"); } }
