    ...
    public class License
    {
        ...
        public abstract class LicenseLevel
        {
            protected LicenseLevel(Licenses level, int lowRange, int highRange, Color? textBrush = null, string display = null)
            {
                ...
                this.TextColor = textBrush ?? Color.White;
        ...
        {
            public LicenseD()
                : base(Licenses.D, 5, 8, Color.Black)
            { }
        }
        ...
        {
            public LicenseC()
                : base(Licenses.C, 9, 12, Color.Black)
            { }
        }
        ...
        {
            public LicensePro()
                : base(Licenses.P, 21, 24, Color.White)
            {
                this.BackgroundOverride = Color.Black;
            }
        }
        ...
        {
            public LicenseProWC()
                : base(Licenses.WC, 25, 28, Color.Black, "WC")
            { }
        }
        ...
        public class LicenseUnknown : LicenseLevel
        {
            public LicenseUnknown()
                : base(Licenses.Unknown, -1, -1, Color.Black, "?")
            {
                this.BackgroundOverride = Color.DarkGray;
            }
        }
    }
}
